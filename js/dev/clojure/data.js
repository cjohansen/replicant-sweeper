...
return cljs.core.reduce.call(null,(function (result,p__9748){
...
var vec__9752 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__9752,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__9752,(1),null);
var ab = cljs.core.nth.call(null,vec__9752,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_9758 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_9758.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_9759 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_9759.call(null,a,b);
}
});
...
return (function (){var G__9763 = clojure.data.equality_partition.call(null,a);
var G__9763__$1 = (((G__9763 instanceof cljs.core.Keyword))?G__9763.fqn:null);
switch (G__9763__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9763__$1)].join('')));

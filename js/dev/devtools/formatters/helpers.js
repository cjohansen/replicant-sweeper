...
var G__13432 = devtools.prefs.pref.call(null,v);
v = G__13432;
continue;
} else {
return v;
...
}catch (e13433){var _e__12695__auto__ = e13433;
return false;
}})();
...
}catch (e13435){var _e__12695__auto__ = e13435;
return false;
}})();
...
}catch (e13437){var _e__12695__auto__ = e13437;
return false;
}}
}
});
...
var vec__13439 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13439,(0),null);
var name = cljs.core.nth.call(null,vec__13439,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13442_SHARP_);
}),template);
});

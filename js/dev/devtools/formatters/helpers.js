...
var G__13178 = devtools.prefs.pref.call(null,v);
v = G__13178;
continue;
} else {
return v;
...
}catch (e13179){var _e__12441__auto__ = e13179;
return false;
}})();
...
}catch (e13181){var _e__12441__auto__ = e13181;
return false;
}})();
...
}catch (e13183){var _e__12441__auto__ = e13183;
return false;
}}
}
});
...
var vec__13185 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13185,(0),null);
var name = cljs.core.nth.call(null,vec__13185,(1),null);
...
return cljs.core.some.call(null,(function (p1__13188_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13188_SHARP_);
}),template);
});

...
var o13330 = temp__5802__auto__;
var temp__5802__auto____$1 = (o13330["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o13331 = temp__5802__auto____$1;
return (o13331["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12688__auto__ = f;
return (o__12688__auto__["toString"]).call(o__12688__auto__);
} else {
return "";
}
}catch (e13332){var _ = e13332;
return "";
}});
...
try{var o__12688__auto___13334 = t;
(o__12688__auto___13334["cljs$lang$ctorPrWriter"]).call(o__12688__auto___13334,t,writer);
}catch (e13333){var __13335 = e13333;
}
...
var char_code = (function (){var o__12688__auto__ = (new String(char$));
return (o__12688__auto__["charCodeAt"]).call(o__12688__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12688__auto__ = String;
return (o__12688__auto__["fromCharCode"]).call(o__12688__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13336 = num_code;
switch (G__13336) {
case (1):
return (185);
...
var o__12688__auto__ = String;
return (o__12688__auto__["fromCharCode"]).call(o__12688__auto__,superscript_code);
});
/**
...
}catch (e13338){var _e__12695__auto__ = e13338;
return false;
}})())){
...
var vec__13339 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13339,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13344){
var vec__13345 = p__13344;
var ns_detector = cljs.core.nth.call(null,vec__13345,(0),null);
...
var G__13351 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13352 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13351;
remaining_tokens = G__13352;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13342){
var G__13343 = cljs.core.first.call(null,seq13342);
var seq13342__$1 = cljs.core.next.call(null,seq13342);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13343,seq13342__$1);
}));
...
var vec__13356 = cljs.core.split_with.call(null,(function (p1__13355_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13355_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13356,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13356,(1),null);
...
var vec__13362 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13362,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13362,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13365 = cljs.core.rest.call(null,remaining_tokens);
var G__13366 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13365;
name_tokens = G__13366;
continue;
} else {
...
var vec__13369 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13369,(0),null);
var arity = cljs.core.nth.call(null,vec__13369,(1),null);
var vec__13372 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13372,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13372,(1),null);
var vec__13375 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13375,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13375,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13375,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13375,(3),null);
...
var vec__13381 = result;
var munged_ns = cljs.core.nth.call(null,vec__13381,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13381,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13381,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13381,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13381,(4),null);
var arity = cljs.core.nth.call(null,vec__13381,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__13385 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__13385,(0),null);
var args = cljs.core.nth.call(null,vec__13385,(1),null);
var vec__13388 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13388,(0),null);
var name = cljs.core.nth.call(null,vec__13388,(1),null);
...
var G__13391 = (arity + (1));
var G__13392 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13393){
var vec__13394 = p__13393;
var arity = cljs.core.nth.call(null,vec__13394,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13394,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13397_SHARP_){
return cljs.core.get.call(null,arities,p1__13397_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__13398_SHARP_){
return cljs.core.drop.call(null,(2),p1__13398_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13401){
var vec__13402 = p__13401;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13402,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13399){
var G__13400 = cljs.core.first.call(null,seq13399);
var seq13399__$1 = cljs.core.next.call(null,seq13399);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13400,seq13399__$1);
}));
...
var map__13410 = options;
var map__13410__$1 = cljs.core.__destructure_map.call(null,map__13410);
var include_ns_QMARK_ = cljs.core.get.call(null,map__13410__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13410__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13410__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13410__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13411 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13411,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13411,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13411,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13411,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13411,(4),null);
var arity = cljs.core.nth.call(null,vec__13411,(5),null);
...
var o__12688__auto__ = f;
return (o__12688__auto__["getBasis"]).call(o__12688__auto__);
});
/**
...
}catch (e13414){var _e__12695__auto__ = e13414;
...
var G__13415 = (obj[cljs.core.first.call(null,path)]);
var G__13416 = cljs.core.rest.call(null,path);
obj = G__13415;
path = G__13416;
continue;
} else {
...
var _STAR_ = (function (accum,p__13417){
var vec__13418 = p__13417;
var bit = cljs.core.nth.call(null,vec__13418,(0),null);
var protocol = cljs.core.nth.call(null,vec__13418,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13421){
var vec__13422 = p__13421;
var ns = cljs.core.nth.call(null,vec__13422,(0),null);
var name = cljs.core.nth.call(null,vec__13422,(1),null);
var selector = cljs.core.nth.call(null,vec__13422,(2),null);
...
var post_process = (function (p__13426){
var vec__13427 = p__13426;
var munged_name = cljs.core.nth.call(null,vec__13427,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13427,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13425_SHARP_){
return (obj[cljs.core.first.call(null,p1__13425_SHARP_)]);
}),sorted_matches);

...
var o12084 = temp__5802__auto__;
var temp__5802__auto____$1 = (o12084["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o12085 = temp__5802__auto____$1;
return (o12085["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11442__auto__ = f;
return (o__11442__auto__["toString"]).call(o__11442__auto__);
} else {
return "";
}
}catch (e12086){var _ = e12086;
return "";
}});
...
try{var o__11442__auto___12088 = t;
(o__11442__auto___12088["cljs$lang$ctorPrWriter"]).call(o__11442__auto___12088,t,writer);
}catch (e12087){var __12089 = e12087;
}
...
var char_code = (function (){var o__11442__auto__ = (new String(char$));
return (o__11442__auto__["charCodeAt"]).call(o__11442__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11442__auto__ = String;
return (o__11442__auto__["fromCharCode"]).call(o__11442__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12090 = num_code;
switch (G__12090) {
case (1):
return (185);
...
var o__11442__auto__ = String;
return (o__11442__auto__["fromCharCode"]).call(o__11442__auto__,superscript_code);
});
/**
...
}catch (e12092){var _e__11449__auto__ = e12092;
return false;
}})())){
...
var vec__12093 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__12093,(0),null);
...
var len__5769__auto___12102 = arguments.length;
var i__5770__auto___12103 = (0);
while(true){
if((i__5770__auto___12103 < len__5769__auto___12102)){
args__5775__auto__.push((arguments[i__5770__auto___12103]));

var G__12104 = (i__5770__auto___12103 + (1));
i__5770__auto___12103 = G__12104;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12098){
var vec__12099 = p__12098;
var ns_detector = cljs.core.nth.call(null,vec__12099,(0),null);
...
var G__12105 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12106 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12105;
remaining_tokens = G__12106;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12096){
var G__12097 = cljs.core.first.call(null,seq12096);
var seq12096__$1 = cljs.core.next.call(null,seq12096);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12097,seq12096__$1);
}));
...
var vec__12110 = cljs.core.split_with.call(null,(function (p1__12109_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12109_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12110,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12110,(1),null);
...
var vec__12116 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12116,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12116,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12119 = cljs.core.rest.call(null,remaining_tokens);
var G__12120 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12119;
name_tokens = G__12120;
continue;
} else {
...
var vec__12123 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12123,(0),null);
var arity = cljs.core.nth.call(null,vec__12123,(1),null);
var vec__12126 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12126,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12126,(1),null);
var vec__12129 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12129,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12129,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12129,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12129,(3),null);
...
var vec__12135 = result;
var munged_ns = cljs.core.nth.call(null,vec__12135,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12135,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12135,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12135,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12135,(4),null);
var arity = cljs.core.nth.call(null,vec__12135,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__12139 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__12139,(0),null);
var args = cljs.core.nth.call(null,vec__12139,(1),null);
var vec__12142 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12142,(0),null);
var name = cljs.core.nth.call(null,vec__12142,(1),null);
...
var G__12145 = (arity + (1));
var G__12146 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12147){
var vec__12148 = p__12147;
var arity = cljs.core.nth.call(null,vec__12148,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12148,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12151_SHARP_){
return cljs.core.get.call(null,arities,p1__12151_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__12152_SHARP_){
return cljs.core.drop.call(null,(2),p1__12152_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___12159 = arguments.length;
var i__5770__auto___12160 = (0);
while(true){
if((i__5770__auto___12160 < len__5769__auto___12159)){
args__5775__auto__.push((arguments[i__5770__auto___12160]));

var G__12161 = (i__5770__auto___12160 + (1));
i__5770__auto___12160 = G__12161;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12155){
var vec__12156 = p__12155;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12156,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12153){
var G__12154 = cljs.core.first.call(null,seq12153);
var seq12153__$1 = cljs.core.next.call(null,seq12153);
var self__5754__auto__ = this;
...
var map__12164 = options;
var map__12164__$1 = cljs.core.__destructure_map.call(null,map__12164);
var include_ns_QMARK_ = cljs.core.get.call(null,map__12164__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12164__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12164__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12164__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12165 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12165,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12165,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12165,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12165,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12165,(4),null);
var arity = cljs.core.nth.call(null,vec__12165,(5),null);
...
var o__11442__auto__ = f;
return (o__11442__auto__["getBasis"]).call(o__11442__auto__);
});
/**
...
}catch (e12168){var _e__11449__auto__ = e12168;
...
var G__12169 = (obj[cljs.core.first.call(null,path)]);
var G__12170 = cljs.core.rest.call(null,path);
obj = G__12169;
path = G__12170;
continue;
} else {
...
var _STAR_ = (function (accum,p__12171){
var vec__12172 = p__12171;
var bit = cljs.core.nth.call(null,vec__12172,(0),null);
var protocol = cljs.core.nth.call(null,vec__12172,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12175){
var vec__12176 = p__12175;
var ns = cljs.core.nth.call(null,vec__12176,(0),null);
var name = cljs.core.nth.call(null,vec__12176,(1),null);
var selector = cljs.core.nth.call(null,vec__12176,(2),null);
...
var post_process = (function (p__12180){
var vec__12181 = p__12180;
var munged_name = cljs.core.nth.call(null,vec__12181,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12181,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__12179_SHARP_){
return (obj[cljs.core.first.call(null,p1__12179_SHARP_)]);
}),sorted_matches);

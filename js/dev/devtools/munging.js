...
var o10436 = temp__5802__auto__;
var temp__5802__auto____$1 = (o10436["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o10437 = temp__5802__auto____$1;
return (o10437["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9794__auto__ = f;
return (o__9794__auto__["toString"]).call(o__9794__auto__);
} else {
return "";
}
}catch (e10438){var _ = e10438;
return "";
}});
...
try{var o__9794__auto___10440 = t;
(o__9794__auto___10440["cljs$lang$ctorPrWriter"]).call(o__9794__auto___10440,t,writer);
}catch (e10439){var __10441 = e10439;
}
...
var char_code = (function (){var o__9794__auto__ = (new String(char$));
return (o__9794__auto__["charCodeAt"]).call(o__9794__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9794__auto__ = String;
return (o__9794__auto__["fromCharCode"]).call(o__9794__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10442 = num_code;
switch (G__10442) {
case (1):
return (185);
...
var o__9794__auto__ = String;
return (o__9794__auto__["fromCharCode"]).call(o__9794__auto__,superscript_code);
});
/**
...
}catch (e10444){var _e__9801__auto__ = e10444;
return false;
}})())){
...
var vec__10445 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10445,(0),null);
...
var len__5769__auto___10454 = arguments.length;
var i__5770__auto___10455 = (0);
while(true){
if((i__5770__auto___10455 < len__5769__auto___10454)){
args__5775__auto__.push((arguments[i__5770__auto___10455]));

var G__10456 = (i__5770__auto___10455 + (1));
i__5770__auto___10455 = G__10456;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10450){
var vec__10451 = p__10450;
var ns_detector = cljs.core.nth.call(null,vec__10451,(0),null);
...
var G__10457 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10458 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10457;
remaining_tokens = G__10458;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10448){
var G__10449 = cljs.core.first.call(null,seq10448);
var seq10448__$1 = cljs.core.next.call(null,seq10448);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10449,seq10448__$1);
}));
...
var vec__10462 = cljs.core.split_with.call(null,(function (p1__10461_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10461_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10462,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10462,(1),null);
...
var vec__10468 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10468,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10468,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10471 = cljs.core.rest.call(null,remaining_tokens);
var G__10472 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10471;
name_tokens = G__10472;
continue;
} else {
...
var vec__10475 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10475,(0),null);
var arity = cljs.core.nth.call(null,vec__10475,(1),null);
var vec__10478 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10478,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10478,(1),null);
var vec__10481 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10481,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10481,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10481,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10481,(3),null);
...
var vec__10487 = result;
var munged_ns = cljs.core.nth.call(null,vec__10487,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10487,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10487,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10487,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10487,(4),null);
var arity = cljs.core.nth.call(null,vec__10487,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__10491 = temp__5802__auto__;
var munged_name = cljs.core.nth.call(null,vec__10491,(0),null);
var args = cljs.core.nth.call(null,vec__10491,(1),null);
var vec__10494 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10494,(0),null);
var name = cljs.core.nth.call(null,vec__10494,(1),null);
...
var G__10497 = (arity + (1));
var G__10498 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10499){
var vec__10500 = p__10499;
var arity = cljs.core.nth.call(null,vec__10500,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10500,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10503_SHARP_){
return cljs.core.get.call(null,arities,p1__10503_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__10504_SHARP_){
return cljs.core.drop.call(null,(2),p1__10504_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___10511 = arguments.length;
var i__5770__auto___10512 = (0);
while(true){
if((i__5770__auto___10512 < len__5769__auto___10511)){
args__5775__auto__.push((arguments[i__5770__auto___10512]));

var G__10513 = (i__5770__auto___10512 + (1));
i__5770__auto___10512 = G__10513;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10507){
var vec__10508 = p__10507;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10508,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10505){
var G__10506 = cljs.core.first.call(null,seq10505);
var seq10505__$1 = cljs.core.next.call(null,seq10505);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10506,seq10505__$1);
}));
...
var map__10516 = options;
var map__10516__$1 = cljs.core.__destructure_map.call(null,map__10516);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10516__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10516__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10516__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10516__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10517 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10517,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10517,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10517,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10517,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10517,(4),null);
var arity = cljs.core.nth.call(null,vec__10517,(5),null);
...
var o__9794__auto__ = f;
return (o__9794__auto__["getBasis"]).call(o__9794__auto__);
});
/**
...
}catch (e10520){var _e__9801__auto__ = e10520;
...
var G__10521 = (obj[cljs.core.first.call(null,path)]);
var G__10522 = cljs.core.rest.call(null,path);
obj = G__10521;
path = G__10522;
continue;
} else {
...
var _STAR_ = (function (accum,p__10523){
var vec__10524 = p__10523;
var bit = cljs.core.nth.call(null,vec__10524,(0),null);
var protocol = cljs.core.nth.call(null,vec__10524,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10527){
var vec__10528 = p__10527;
var ns = cljs.core.nth.call(null,vec__10528,(0),null);
var name = cljs.core.nth.call(null,vec__10528,(1),null);
var selector = cljs.core.nth.call(null,vec__10528,(2),null);
...
var post_process = (function (p__10532){
var vec__10533 = p__10532;
var munged_name = cljs.core.nth.call(null,vec__10533,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10533,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__10531_SHARP_){
return (obj[cljs.core.first.call(null,p1__10531_SHARP_)]);
}),sorted_matches);
